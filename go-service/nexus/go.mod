module github.com/AdrianWangs/ai-nexus/go-service/nexus
...
require (
	github.com/AdrianWangs/ai-nexus/go-common v0.0.0-00010101000000-000000000000
	github.com/AdrianWangs/ai-nexus/go-service/user v0.0.0-20240820090237-ddeb56332f98
