...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.ThirdPartyToken = field.NewString(tableName, "third_party_token")
...
func (u *user) updateTableName(table string) *user {
	...
	u.ThirdPartyToken = field.NewString(table, "third_party_token")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["third_party_token"] = u.ThirdPartyToken
}
